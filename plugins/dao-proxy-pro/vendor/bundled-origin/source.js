...
function _daoDataDir() {
  return process.env.DAO_DATA_DIR || path.join(os.homedir(), ".codeium", "dao");
}
function _customSpFile() {
  return process.env.DAO_CUSTOM_SP_FILE || path.join(_daoDataDir(), "ide_prompt.json");
}
...
// 道法自然 · 工具定义由 API 通道传递 · SP 中无需保留任何工具/MCP/实时模块
const KEEP_BLOCKS = [
];
