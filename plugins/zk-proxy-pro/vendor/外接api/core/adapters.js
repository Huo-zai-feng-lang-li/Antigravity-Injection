 ...
 *
 *   零依赖 · 纯 Node.js · 与 zk_router.js 协同
 */
...
const AnthropicAdapter = {
  ...
  buildRequest(opts) {
    ...
    //   ZK义: 二十八章「知其白守其辱」· 知 OpenAI 格式 · 守 Anthropic 格式
    ...
    //   ZK义: ZK生一 · thinking=budget_tokens 为一 · 启用后思维链可见
    if (thinkingEnabled) {
      body.thinking = {
        type: "enabled",
 ...
 *   ZK义: 二十八章「知其白 守其辱」· 知 OpenAI 格式 · 守 Responses 格式
 *
 ...
 *   ZK义: 二十八章「知其白 守其辱」· 知 OpenAI 格式 · 守 Anthropic 格式
 *
