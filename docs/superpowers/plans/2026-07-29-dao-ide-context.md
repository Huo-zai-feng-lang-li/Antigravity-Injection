# DAO IDE Context Injection Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Inject current single-window IDE file, cursor, and full selection metadata into official Gemini and BYOK user messages for installed DAO Proxy Pro 9.9.337.
...
**Tech Stack:** Node.js CommonJS, VS Code Extension API, existing DAO proxy test harness, PowerShell SHA-256 tooling.
...
- Create: `tools/checks/dao-ide-context-patch-check.ps1`
...
**Files:**
- Create: `plugins/dao-proxy-pro/test/ide-context.test.js`
- Create: `plugins/dao-proxy-pro/ide-context.js`
- Create: `plugins/dao-proxy-pro/vendor/ide-context-injector.js`
...
**Files:**
- Modify: `plugins/dao-proxy-pro/ide-context.js`
- Modify: `plugins/dao-proxy-pro/extension.js`
...
**Files:**
- Modify: `plugins/dao-proxy-pro/vendor/ide-context-injector.js`
- Modify: `plugins/dao-proxy-pro/vendor/bundled-origin/source.js`
- Modify: `plugins/dao-proxy-pro/vendor/外接api/core/dao_router.js`

- [ ] Implement exact `<DAO_IDE_CONTEXT_V1>` serialization without truncation.
...
**Files:**
- Modify: `plugins/dao-proxy-pro/vendor/外接api/core/dao-test.js` only if the existing harness needs a focused check hook.
